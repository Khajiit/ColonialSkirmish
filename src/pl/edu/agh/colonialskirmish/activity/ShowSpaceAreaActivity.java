...
public class ShowSpaceAreaActivity extends FragmentActivity {
	...
	private void setupTabs() {
		...
		tabHost.addTab(tabHost.newTabSpec("Moje").setIndicator("Moje"), SelectShipActivity.class, bundleMyTab);
		tabHost.addTab(tabHost.newTabSpec("Przeciwnika").setIndicator("Przeciwnika"), SelectShipActivity.class, bundleEnemyTab);
	}
