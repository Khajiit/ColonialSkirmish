...
public class GameSQLiteHelper extends SQLiteOpenHelper {
	...
	private static final String QUERY_CREATE_DECK_TABLE = "CREATE TABLE " + DECK_TABLE_NAME + " (" + 
			...
			COLUMN_CARD_NAME + TEXT_TYPE + "," +
			COLUMN_CARD_COST + INT_TYPE + "," +
			COLUMN_CARD_DESCRIPTION + TEXT_TYPE + "," +
			COLUMN_CARD_KINETIC_ATT + INT_TYPE + "," +
			COLUMN_CARD_KINETIC_DEF + INT_TYPE + "," +
			COLUMN_CARD_ENERGY_ATT + INT_TYPE + "," +
			COLUMN_CARD_ENERGY_DEF + INT_TYPE + "," +
			COLUMN_CARD_MISSLE_ATT + INT_TYPE + "," +
			COLUMN_CARD_MISSLE_DEF + INT_TYPE + "," +
			COLUMN_CARD_HEALTH + INT_TYPE + "," +
			COLUMN_CARD_MAIN_TYPE + TEXT_TYPE + "," +
			COLUMN_CARD_SECONDARY_TYPE + TEXT_TYPE + "," +
			COLUMN_CARD_IMAGE + BLOB_TYPE +
			")";
